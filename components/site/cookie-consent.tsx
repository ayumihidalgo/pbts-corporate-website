  ...
  return (
    <>
      <div
        ...
        className="fixed inset-x-0 bottom-0 z-[90] border-t border-white/10 bg-navy px-5 py-5 text-white shadow-2xl lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex items-start gap-3">
              <span className="mt-0.5 inline-flex size-9 shrink-0 items-center justify-center rounded-lg bg-white/10 text-orange">
                <ShieldCheck className="size-5" />
              </span>
              <div>
                <h2 id="cookie-consent-title" className="font-display text-sm font-semibold text-white">
                  Cookie preferences
                </h2>
                <p className="mt-1 max-w-2xl text-sm leading-relaxed text-white/70">
                  ...
                  <button
                    ...
                    className="font-semibold text-white underline underline-offset-2 transition-colors hover:text-orange"
                  >
                    Privacy Policy
                  </button>{' '}
                  for details.
            ...
            <div className="flex shrink-0 flex-wrap items-center gap-2.5 sm:pl-4">
              <button
                ...
                className="rounded-full border border-white/20 bg-white/5 px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-white/10"
              >
                Manage
              </button>
              <button
          ...
          {expanded && (
            <div className="mt-5 space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="flex items-start justify-between gap-4">
                ...
                <span className="mt-0.5 shrink-0 rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold text-white/70">
                  Always active
                </span>
              </div>
              ...
              <div className="flex items-start justify-between gap-4 border-t border-white/10 pt-3">
                ...
                <input
                  ...
                  className="mt-0.5 size-5 shrink-0 rounded border-white/30 bg-transparent text-orange accent-orange outline-none focus:ring-4 focus:ring-orange/30"
                />
              </div>
