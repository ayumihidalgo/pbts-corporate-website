...
const categories: Category[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: LifeBuoy,
        title: 'IT Helpdesk & Support',
        desc: 'Responsive technical support to keep users and systems productive.',
        image: 'https://images.unsplash.com/photo-1519337265831-281ec6cc8514?w=640&h=480&fit=crop&auto=format&q=70',
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: ScanEye,
        title: 'Vision Systems',
        desc: 'Machine vision for inspection, sorting, and quality control on the line.',
        image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Boxes,
        title: 'System Integration',
        desc: 'End-to-end integration across equipment, controls, and production lines.',
        image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: CalendarCheck,
        title: 'Preventive Maintenance',
        desc: 'Scheduled inspection and upkeep programs that reduce unplanned downtime.',
        image: 'https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Lightbulb,
        title: 'Engineering Consultancy',
        desc: 'Independent engineering advice for process, layout, and equipment decisions.',
        image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=640&h=480&fit=crop&auto=format&q=70',
      },
    ],
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1523875194681-bedd468c58bf?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Shield,
        title: 'Board Testing & Validation',
        desc: 'Load testing and burn-in validation before boards go back into service.',
        image: 'https://images.unsplash.com/photo-1585152968992-d2b9444408cc?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Search,
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1567789884554-0b844b597180?w=640&h=480&fit=crop&auto=format&q=70',
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Layers,
        title: 'Sheet Metal Forming',
        desc: 'Cutting, bending, and forming for enclosures, panels, and custom parts.',
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: PenTool,
        title: 'Custom Tooling & Jigs',
        desc: 'Purpose-built tooling, jigs, and fixtures for repeatable production.',
        image: 'https://images.unsplash.com/photo-1565043666747-69f6646db940?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Cog,
        title: 'Motor Repair',
        desc: 'Rewinding, rebuilding, and testing for industrial motors of all sizes.',
        image: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Wrench,
    ...
    services: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: PackageSearch,
        title: 'Racking & Storage Systems',
        desc: 'Racking, shelving, and storage systems designed around your inventory flow.',
        image: 'https://images.unsplash.com/photo-1517420704952-d9f39e95b43e?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Truck,
        title: 'Material Handling Systems',
        desc: 'Conveyors, lifts, and handling equipment that move goods efficiently.',
        image: 'https://images.unsplash.com/photo-1580927752452-89d86da3fa0a?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Bot,
        title: 'Warehouse Automation',
        desc: 'Automated guided systems and smart controls for high-volume facilities.',
        image: 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: ClipboardList,
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        desc: 'Grading, excavation, and earthworks to prepare a site for construction.',
        image: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: ClipboardCheck,
    ...
    services: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1533709752211-118fcaf03312?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Zap,
