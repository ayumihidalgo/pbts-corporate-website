    ...
    services: [
      {
        ...
        image: 'https://images.unsplash.com/photo-6Uk4rDFaqPI?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Flower2,
        title: 'Grounds Design',
        desc: 'Grounds and hardscape design for corporate and industrial sites.',
        image: 'https://images.unsplash.com/photo-atYoXjIr8qY?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Sun,
        title: 'Landscape Maintenance',
        desc: 'Ongoing upkeep to keep facility grounds presentable year-round.',
        image: 'https://images.unsplash.com/photo-BKBRtbcjlxI?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: Droplets,
        title: 'Irrigation Systems',
        desc: 'Irrigation design and installation sized to the site and planting.',
        image: 'https://images.unsplash.com/photo-aKeWIzx9-iM?w=640&h=480&fit=crop&auto=format&q=70',
      },
      {
        icon: LayoutGrid,
        title: 'Hardscape Installation',
        desc: 'Paving, walkways, and hardscape installation for facility grounds.',
        image: 'https://images.unsplash.com/photo-A5IILTdd-WI?w=640&h=480&fit=crop&auto=format&q=70',
      },
    ],
  },
]
